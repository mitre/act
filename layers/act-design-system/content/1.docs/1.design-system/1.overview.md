...
The ACT™ Design System is a comprehensive theming layer that provides consistent spacing, typography, and visual design across MITRE ACT applications.
...
The design system is implemented as a Nuxt layer that includes:
...
├── app.config.ts               # Design tokens and component defaults
├── assets/css/
│   └── design-system.css       # Custom spacing and typography
├── components/                 # Custom ACT components
└── content/docs/               # This documentation
```

## Quick Start

The design system is automatically applied when the layer is included in your Nuxt configuration:
