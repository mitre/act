...
::div{class="flex gap-4 mt-6"}
  ::button{icon="i-heroicons-folder-arrow-down" :to="/downloads/act-templates/C-07 - ACT Final Package Folder Structure.zip" target="_blank" variant="solid" color="primary" size="lg"}
